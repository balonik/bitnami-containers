...
export KEYCLOAK_DATABASE_HOST="${KEYCLOAK_DATABASE_HOST:-mssql}"
KEYCLOAK_DATABASE_PORT="${KEYCLOAK_DATABASE_PORT:-"${DB_PORT:-}"}"
export KEYCLOAK_DATABASE_PORT="${KEYCLOAK_DATABASE_PORT:-1433}"
...
export KEYCLOAK_DATABASE_NAME="${KEYCLOAK_DATABASE_NAME:-AUTH}"
